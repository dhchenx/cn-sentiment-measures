...
Chinese Sentiment Analysis Toolkit with Multiple Measures
...
setup(
    ...
    name='cn-sentiment-measures',  # Required
    ...
    description='A toolkit for estimating Chinese sentiment scores with multiple measures.',  # Optional
    ...
    url='https://github.com/dhchenx/cn-sentiment-measures',  # Optional
